...
def test_range():
    ...
    assert Range(Position(0, 2), Position(3, 4)) \
            != Range(Position(1, 2), Position(3, 4))
    assert Range(Position(0, 2), Position(3, 4)) != None
...
def test_location():
    ...
    assert Location(uri="file:///document.txt", range=Range(Position(1, 2), Position(3, 4))) \
            != None
    assert "file:///document.txt:1:2-3:4" == repr(Location(uri="file:///document.txt", range=Range(Position(1, 2), Position(3, 4))))
